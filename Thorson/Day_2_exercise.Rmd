...
*	$x_i~\mathrm{Normal}(2,\sigma_X^2 )$ indicates that $x_i$ is simulated from a normal distribution, which can be done in R using `rnorm( n = 100, mean = 2, sd = 1)`
...
\end{cases}
$$
Where process errors $\epsilon_{a,t}~\mathrm{Normal}(0,\sigma^2)$, median age-0 recruitment $\mu_R=10^9$ [individuals], recruitment variation $\sigma_1=0.6$ [dimensionless], demographic variation $\sigma_2=0.1$ [dimensionless], and natural mortality $m=0.4$ [per year].
